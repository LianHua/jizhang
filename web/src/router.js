...
const routes = [
  { path: "/login", name: "login", component: () => import("./views/Login.vue"), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: "utility", name: "utility", component: () => import("./views/Utility.vue") },
      { path: "utility-rules", name: "utility-rules", component: () => import("./views/UtilityRules.vue") },
      { path: "savings", name: "savings", component: () => import("./views/Savings.vue") },
